...
class TodoModal extends React.Component {
    ...
    addTodoHandler = () => {
        ...
        this.props.addTempData(name, { title: todo, completed: false})
        this.setState( { todo: '' })
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <KeyboardAvoidingView style={[styles.section, styles.footer]} behavior="padding">
                    <TextInput style={[styles.input, {borderColor: this.state.color}]} value={this.state.todo} onChangeText={text => this.setState({todo: text})}/>
                    <TouchableOpacity style={[styles.addTodo, {backgroundColor: this.state.color}]} onPress={this.addTodoHandler}>
